...
violet_red = (199,0,120)
berry = (130 ,0 , 130)

#load desired colors
colors.extend([deep_pink, white, red, berry, green, violet_red, blue, gold, cyan, black])

#welcome message

sense.show_message("Raspimon Builder." , text_colour=coral, scroll_speed=.09)
